...
public class TypeMismatchWithSubexprError extends TypecheckingError {
  ...
  public Doc getBodyDoc(PrettyPrinterConfig ppConfig) {
    termDoc1 = new TermWithSubtermDoc(result.wholeExpr1, result.subExpr1, result.levels1, null, ppConfig);
    termDoc2 = new TermWithSubtermDoc(result.wholeExpr2, result.subExpr2, result.levels2, null, ppConfig);

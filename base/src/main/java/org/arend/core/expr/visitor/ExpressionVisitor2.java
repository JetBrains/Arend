...
public interface ExpressionVisitor2<P1,P2,R> {
  ...
  R visitQName(QNameExpression expr, P1 param1, P2 param2);
  ...
  R visitPath(PathExpression expr, P1 param1, P2 param2);
  R visitAt(AtExpression expr, P1 param1, P2 param2);
  R visitData(DataExpression expr, P1 param1, P2 param2);
}

...
public interface Library {
   ...
   * The result should contain modules generated by the language extension.
   * This method may be invoked only after the library is successfully loaded.
   *
   * @return a scope provider for all modules in this library.
   */
  @NotNull
  ModuleScopeProvider getModuleScopeProvider();

  /**
   * Gets the module scope provider that contains modules declared in this library.
   * The result does not contain modules generated by the language extension.
   *
   * @return a module scope provider for modules declared in this library.
   */
  @NotNull

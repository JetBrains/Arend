...
public class RawDefinitionProviderImpl extends Disableable implements RawDefinitionProvider {
  private final TypecheckingOrderingListener myTypechecking;
  private final DefinitionRequester myDefinitionRequester;
  private final Library myLibrary;

  public RawDefinitionProviderImpl(TypecheckingOrderingListener typechecking, DefinitionRequester definitionRequester, Library library) {

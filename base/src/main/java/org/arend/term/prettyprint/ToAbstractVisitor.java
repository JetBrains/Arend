...
public class ToAbstractVisitor extends BaseExpressionVisitor<Void, Concrete.Expression> implements DefinitionVisitor<Void, Concrete.GeneralDefinition> {
  ...
  public Concrete.Expression visitQName(QNameExpression expr, Void params) {
    return new Concrete.QNameLiteral(null, new Concrete.ReferenceExpression(null, expr.getRef()));
  }
  ...
  @Override
  public Concrete.Expression visitData(DataExpression expr, Void params) {

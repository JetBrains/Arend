...
public class FreeReferablesVisitor implements ConcreteExpressionVisitor<Void, TCReferable> {
  ...
  public TCReferable visitPattern(Concrete.Pattern pattern) {
    if (pattern.getAsReferable() != null && pattern.getAsReferable().type != null) {
      TCReferable ref = pattern.getAsReferable().type.accept(this, null);
      if (ref != null) {
        return ref;
      }
    }
    ...
    if (pattern instanceof Concrete.NamePattern) {
      ...
      if (namePattern.type != null) {
        TCReferable ref = namePattern.type.accept(this, null);
        if (ref != null) {
          return ref;
        }
      }
      Referable ref = namePattern.getReferable();
  ...
  @Override
  public TCReferable visitApplyHole(Concrete.ApplyHoleExpression expr, Void params) {
    return null;
  }

...
public interface ConcreteExpressionVisitor<P, R> {
  ...
  R visitThis(Concrete.ThisExpression expr, P params);
  ...
  R visitBox(Concrete.BoxExpression expr, P params);

...
public class PrettyPrintingTest extends TypeCheckingTestCase {
  ...
  public void fieldCallTest() {
    ...
    Expression expr = FieldCallExpression.make(def.getPersonalFields().get(0), Levels.EMPTY, new ReferenceExpression(new TypedBinding("r", new ClassCallExpression(def, Levels.EMPTY))));

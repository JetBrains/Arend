...
public class ExpressionTest {
  ...
  public void typeCheckingLam() {
    ...
    expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Nat(), Nat()), errors);
  ...
  public void typeCheckingLamError() {
    ...
    Expression expr = Lam("x", Index(0));
    List<TypeCheckingError> errors = new ArrayList<>();
    assertEquals(null, expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Nat(), Pi(Nat(), Nat())), errors));
  ...
  public void typeCheckingId() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), type, errors);
    assertEquals(0, errors.size());
  }
  ...
  public void typeCheckingIdError() {
    ...
    Expression type = Pi("X", Universe(0), Pi(Index(0), Index(0)));
    List<TypeCheckingError> errors = new ArrayList<>();
    assertEquals(null, expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), type, errors));
    assertEquals(1, errors.size());
    assertTrue(errors.get(0) instanceof TypeMismatchError);
  }
  ...
  public void typeCheckingApp() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Nat(), Pi(Pi(Nat(), Nat()), Nat())), errors);
    assertEquals(0, errors.size());
  }
  ...
  public void typeCheckingInferPi() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    assertEquals(Universe(2), expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), null, errors).type);
    assertEquals(0, errors.size());
  }
  ...
  public void typeCheckingUniverse() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    assertEquals(null, expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), null, errors));
    assertEquals(1, errors.size());
    assertTrue(errors.get(0) instanceof TypeMismatchError);
  }
  ...
  public void tooManyLambdasError() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    assertNull(expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Nat(), Nat()), errors));
    assertEquals(1, errors.size());
  }
  ...
  public void typedLambdaExpectedType() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    assertEquals(expr, expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(args(Tele(vars("X"), Universe(0)), TypeArg(Index(0))), Index(1)), errors).expression);
    assertEquals(0, errors.size());
  }
  ...
  public void lambdaExpectedError() {
    ...
    Expression expr = Lam("x", Var("x"));
    List<TypeCheckingError> errors = new ArrayList<>();
    CheckTypeVisitor.OKResult result = expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Pi(Nat(), Nat()), Nat()), errors);
    assertEquals(1, errors.size());
  ...
  public void lambdaExpectedError2() {
    ...
    List<TypeCheckingError> errors = new ArrayList<>();
    CheckTypeVisitor.OKResult result = expr.checkType(Prelude.DEFINITIONS, new ArrayList<Binding>(), Pi(Pi(Nat(), Nat()), Pi(Nat(), Nat())), errors);
    assertEquals(1, errors.size());
    assertEquals(null, result);
    assertTrue(errors.get(0) instanceof TypeMismatchError);
  }

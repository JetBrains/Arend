...
public class CachingTestCase extends NameResolverTestCase {
  ...
  public void initialize() {
    ...
    typechecking = new Typechecking(tcState, staticNsProvider, dynamicNsProvider, Concrete.NamespaceCommandStatement.GET, errorReporter, new TypecheckedReporter() {
      @Override
  ...
  protected void loadPrelude() {
    ...
    new Typechecking(cacheManager.getTypecheckerState(), staticNsProvider, dynamicNsProvider, Concrete.NamespaceCommandStatement.GET, new DummyErrorReporter(), new Prelude.UpdatePreludeReporter(cacheManager.getTypecheckerState()), new DependencyListener() {}).typecheckModules(Collections.singleton(this.prelude));

...
public class NameResolverTest extends NameResolverTestCase {
  ...
  public void parserInfix() {
    ...
    Concrete.Definition plus = new Concrete.FunctionDefinition(plusRef, Collections.emptyList(), null, null, false);
    ...
    Concrete.Definition mul = new Concrete.FunctionDefinition(mulRef, Collections.emptyList(), null, null, false);

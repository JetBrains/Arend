...
public class ParserTest extends ParserTestCase {
  ...
  public void parserImplicit() {
    ...
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(0)).getType()));
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(1)).getType()));
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(2)).getType()));
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(3)).getType()));
    assertTrue(compareAbstract(cApps(cVar("A"), cVar("x"), cVar("y"), cVar("z"), cVar("w"), cVar("t"), cVar("r")), def.getResultType()));
  }
  ...
  public void parserImplicit2() {
    ...
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(1)).getType()));
    assertTrue(compareAbstract(cUniverse(1), ((Concrete.TypeArgument) def.getArguments().get(2)).getType()));
    assertTrue(compareAbstract(cApps(cVar("A"), cVar("x"), cVar("y"), cVar("z")), ((Concrete.TypeArgument) def.getArguments().get(4)).getType()));
    assertTrue(compareAbstract(cUniverse(1), def.getResultType()));
  }

...
public class PrettyPrintingTest {
  ...
  public void prettyPrintingFunDef() {
    ...
    FunctionDefinition def = new FunctionDefinition(new Namespace("test"), new Name("f"), null, Abstract.Definition.DEFAULT_PRECEDENCE, arguments, Index(1), Definition.Arrow.RIGHT, Lam("X", Lam("x", Index(0))));

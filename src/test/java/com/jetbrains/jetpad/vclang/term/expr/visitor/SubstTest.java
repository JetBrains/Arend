...
public class SubstTest {
  ...
  public void substLet() {
    ...
    Expression expr1 = Let(lets(let("x", args(Tele(vars("z"), Nat())), Index(0)), let("y", args(Tele(vars("w"), Nat())), Index(2))), Index(2));
    Expression expr2 = Let(lets(let("x", args(Tele(vars("z"), Nat())), Index(0)), let("y", args(Tele(vars("w"), Nat())), Zero())), Zero());

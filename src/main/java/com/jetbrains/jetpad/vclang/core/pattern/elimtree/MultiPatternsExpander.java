...
import com.jetbrains.jetpad.vclang.core.pattern.elimtree.PatternsExpander.Branch;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static com.jetbrains.jetpad.vclang.core.pattern.elimtree.PatternsExpander.recalcIndices;
...
public class MultiPatternsExpander {
  ...
  public static MultiElimTreeExpansionResult expandPatterns(DependentLink eliminatingArgs, List<List<Pattern>> patterns) {
    return expandPatterns(DependentLink.Helper.toContext(eliminatingArgs), patterns, new ArrayList<Binding>());
  }

...
public class Prelude extends Namespace {
  ...
  static {
    ...
    Expression setTruncConParameter3type = FunCall(PATH_INFIX).applyLevelSubst(new LevelSubstitution(PathLp, new LevelExpression(truncLp), PathLh, new LevelExpression(0)))

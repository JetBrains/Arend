...
public abstract class ElimTreeNode {
  ...
  public boolean equals(Object obj) {
    return this == obj || obj instanceof ElimTreeNode && CompareVisitor.compare(DummyEquations.getInstance(), Equations.CMP.EQ, new ArrayList<Binding>(), this, (ElimTreeNode) obj);
  }

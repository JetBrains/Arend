...
public class DataDefinition extends Definition implements Abstract.DataDefinition {
  ...
  public DataDefinition(String name, ClassDefinition module, Precedence precedence, Fixity fixity, Universe universe, List<TypeArgument> parameters, List<Constructor> constructors) {

...
public class Name {
  ...
  public Name(String name) {
    this.name = name;
    this.fixity = name.isEmpty() || name.charAt(0) == '_' || name.charAt(0) == '?' || name.charAt(0) == '\\' || Character.isLetter(name.charAt(0)) ? Abstract.Definition.Fixity.PREFIX : Abstract.Definition.Fixity.INFIX;
  }

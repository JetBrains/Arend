...
public abstract class UniverseOld {
  ...
  public abstract Cmp compare(UniverseOld other);
  public abstract UniverseOld succ();

  public boolean lessOrEquals(UniverseOld other) {
    Cmp result = compare(other);
    return result == Cmp.LESS || result == Cmp.EQUALS;
  }

  public abstract UniverseOld max(UniverseOld other);
  ...
  public static class Type extends UniverseOld {
    ...
    @Override
    public Cmp compare(UniverseOld other) {
    ...
    @Override
    public Type max(UniverseOld other) {

...
public class ModuleMapper extends Mapper<Module, ModuleCell> {
  ...
  protected void registerSynchronizers(SynchronizersConfiguration conf) {
    ...
    ProjectionalRoleSynchronizer<Module, Definition> synchronizer = ProjectionalSynchronizers.forRole(this, getSource().definitions, getTarget().definitions, CellLists.newLineSeparated(getTarget().definitions.children()), DefinitionMapperFactory.getInstance());

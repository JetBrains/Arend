...
public class OneshotSourceInfoCollector<SourceIdT extends SourceId> {
  ...
  public void visitModule(SourceIdT moduleID, Concrete.ClassDefinition module) {
    DefinitionSourceInfoVisitor<SourceIdT, ?> vis = new DefinitionSourceInfoVisitor<>(sourceInfoProvider, moduleID);

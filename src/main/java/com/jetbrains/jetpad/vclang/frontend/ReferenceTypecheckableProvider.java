...
public class ReferenceTypecheckableProvider implements TypecheckableProvider {
  public static final TypecheckableProvider INSTANCE = new ReferenceTypecheckableProvider();

...
public interface AbstractExpressionVisitor<P, R> {
  ...
  R visitCase(@Nullable Object data, @Nonnull Collection<? extends Abstract.CaseArgument> arguments, @Nullable Abstract.Expression resultType, @Nonnull Collection<? extends Abstract.FunctionClause> clauses, @Nullable Abstract.ErrorData errorData, P params);

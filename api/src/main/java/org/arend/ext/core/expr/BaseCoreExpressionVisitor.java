...
public abstract class BaseCoreExpressionVisitor<P, R> implements CoreExpressionVisitor<P, R> {
  ...
  @Override
  public R visitString(@NotNull CoreStringExpression expr, P params) {
    return visit(expr, params);
  }
  ...
  @Override
  public R visitTypeDestructor(@NotNull CoreTypeDestructorExpression expr, P params) {
    return visit(expr, params);
  }

  @Override
  public R visitArray(@NotNull CoreArrayExpression expr, P params) {
    return visit(expr, params);
  }

  @Override
  public R visitPath(@NotNull CorePathExpression expr, P params) {
    return visit(expr, params);
  }
